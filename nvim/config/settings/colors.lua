...
hi("TelescopeNormal",         { fg = c.white, bg = c.bg })
hi("TelescopeBorder",         { fg = c.white, bg = c.bg })
hi("TelescopePromptNormal",   { fg = c.white, bg = c.bg })
hi("TelescopePromptBorder",   { fg = c.white, bg = c.bg })
hi("TelescopePromptTitle",    { fg = c.green, bg = c.bg })
hi("TelescopeResultsNormal",  { fg = c.white, bg = c.bg })
hi("TelescopeResultsBorder",  { fg = c.white, bg = c.bg })
hi("TelescopeResultsTitle",   { fg = c.green, bg = c.bg })
hi("TelescopePreviewNormal",  { fg = c.white, bg = c.bg })
hi("TelescopePreviewBorder",  { fg = c.green, bg = c.bg })
hi("TelescopePreviewTitle",   { fg = c.green, bg = c.bg })

hi("TelescopeSelection",      { fg = c.green, bg = c.bg })
hi("TelescopeSelectionCaret", { fg = c.green, bg = c.bg })
hi("TelescopeMatching",       { fg = c.green, bg = c.bg, bold = true })

hi("TelescopeMultiSelection", { fg = c.green, bg = c.bg })
hi("TelescopeMultiIcon",      { fg = c.green, bg = c.bg })
